      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center space-y-8">
          ...
          <p className="max-w-2xl mx-auto text-xl text-gray-600 animate-fade-in-delay-1">
            Get personalized deals from Amazon, Myntra, Flipkart, and AJIO
            delivered straight to your WhatsApp. Save big without the endless
            browsing.
          </p>
          ...
          <div className="flex justify-center items-center space-x-4 animate-fade-in-delay-2">
            <Link
              href={"/login"}
              className="group bg-indigo-600 text-white px-8 py-4 rounded-lg hover:bg-indigo-700 transition-colors flex items-center space-x-2"
            >
